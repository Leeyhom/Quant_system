# -*- coding: utf-8 -*-
"""
JoinQuant A-share simulation strategy v4.
...
This is the non-simplified execution adapter for the local M14 A-share logic:
    ...
    - fixed 6-stock portfolio, at most two stocks per industry, 95% max exposure
...
60000 CNY. The strategy rebalances at 14:30 every 30 trading days.
"""
...
REBALANCE_DAYS = 30
TRADE_TIME = "14:30"
STRATEGY_VERSION = "jq-cn-sim-v4-top6-reb30-ind2"
...
def rebalance(context):
    ...
    log.info(
        "v4 rebalance %s factors=%s candidates=%s scored=%s targets=%s",
        today,
...
def build_scores(context, stocks):
    ...
    log.info("v4 factor columns before scoring: %s", ",".join(frame.columns))
